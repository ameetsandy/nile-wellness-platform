...
const GoogleTranslate = () => {
  ...
  return (
    <div 
      ...
      className="absolute top-[1.25rem] left-14 md:left-auto md:right-4 z-[60] bg-white rounded-lg p-1.5 md:p-2 shadow-md flex items-center gap-1.5 md:gap-2 scale-90 md:scale-100"
      style={{ direction: 'ltr' }}
    >
