            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <div className="flex flex-wrap gap-3 mt-4">
                  ...
                  <span className="bg-white border border-nile-100 text-nile-700 px-4 py-2 rounded-lg text-sm font-semibold shadow-sm">96.8%+ Success Rate</span>
                </div>
              </div>
              <div className="relative flex items-end lg:justify-end mt-8 lg:mt-0">
                ...
                <span className="absolute -bottom-6 left-0 bg-nile-600 text-white px-6 py-3 rounded-lg text-sm font-semibold shadow-lg whitespace-nowrap">
                  81% Cost Savings vs Western Countries
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              ...
              <Button 
                ...
                onClick={handleWhatsAppClick}
              >
                <Phone className="mr-2 h-5 w-5" /> Speak to a Brain Surgery Specialist
              </Button>
            </div>
          </div>
        </section>
