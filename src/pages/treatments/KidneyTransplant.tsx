...
import { Activity, ShieldCheck, Phone, MessageCircle } from "lucide-react";
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="bg-white p-8 rounded-xl shadow-md">
                <div className="flex items-center mb-6">
                  <ShieldCheck className="text-nile-600 mr-3 h-8 w-8" />
                  <h2 className="text-2xl font-bold">Why Choose India?</h2>
                </div>
                <p className="text-gray-700">
                  India is one of the most trusted destinations for kidney transplant procedures due to its advanced nephrology departments, world-renowned urologists, and strict organ transplant protocols. Indian hospitals maintain high standards in donor matching, pre-transplant evaluation, surgery, and post-operative care. The cost is up to 80% lower than Western countries, and patients benefit from fast-track transplant clearance, government-licensed hospitals, and multilingual coordination teams for a seamless experience.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                <div className="h-48 overflow-hidden">
                  <img
                    src="https://placehold.co/800x600/nile-600/white/?text=MMM"
            ...
            <div className="max-w-3xl mx-auto">
              <Tabs defaultValue="tab1" className="w-full">
                <TabsList className="grid w-full grid-cols-3 mb-8">
                  ...
                  <TabsTrigger value="tab3">Post Surgery</TabsTrigger>
                </TabsList>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Button className="bg-green-600 hover:bg-green-700 text-lg py-6">
                <MessageCircle className="mr-2 h-5 w-5" /> Send Reports via WhatsApp for Free Evaluation
              </Button>
